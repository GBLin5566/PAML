...
class Translator(object):
    ...
    def translate_batch(self, src_seq):
        ...
        def get_inst_idx_to_tensor_position_map(inst_idx_list):
            ...
            return {
                inst_idx: tensor_position for tensor_position,
                inst_idx in enumerate(inst_idx_list)}
        ...
        def beam_decode_step(
            ...
            def predict_word(
                ...
                mask_src = torch.cat(
                    [mask_src[0].unsqueeze(0)] * mask_trg.size(0), 0)
